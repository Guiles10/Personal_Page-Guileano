    ...
    return(
        <StyledSobre id='sobre' ref={sobreRef}>
            <div>
                ...
                <p>Apaixonado pela area já desenvolvi mais de 30 projetos, dês de projetos bem simples para praticar lógica de programação e metodologias ágeis, até projetos mais complexos utilizando Api, bibliotecas, páginas de loguin, cadastro, paginação, autologin. Hoje conseguindo criar projetos completos com regras de negócios, estilização, banco de dados utilizando habilidades front end e back end.</p>
                <p>Tambem tive a experiencia de fazer trabalhos em equipe e ser monitor de ensino, auxiliando e orientando alunos da Kenzie a resolver bugs em seus códigos, podendo assim botar em prática não apenas as hards skills, mas tambem as soft skills, habilidades fundamentais pata um desenvolvedor.</p>
                <p>Tenho como objetivo na carreira me tornar um Tech Lider Sênio, ajudando a construir grandes aplicações que tenham milhares de usuários pelo mundo.</p>
